This is my notebook that retrieves data from the mulitple api's that cover radio navigational warngings across the Baltic Sea. It then plots all current warnings in a map.
